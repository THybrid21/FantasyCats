...
pelt_colours = ['WHITE', 'PALECREAM', 'PANTONE', 'CREAM', 'BANNANA', 'HAY', 
    ...
    'SAPPHIRE', 'OCEAN', 'ORCHID', 'FLORAL', 'CHERRY', 'BEE', 'YELLOW', 'PYRITE', 
...
pelt_c_no_white = ['PALECREAM', 'PANTONE', 'CREAM', 'BANNANA', 'HAY', 
    ...
    'CHERRY', 'BEE', 'YELLOW', 'PYRITE', 'GREEN', 'SEAWEED', 'SACRAMENTO', 'TEAL', 
...
tortiepatterns = ['ONE', 'TWO', 'THREE', 'FOUR', 'REDTAIL', 'DELILAH', 'MINIMALONE', 'MINIMALTWO', 'MINIMALTHREE', 'MINIMALFOUR',
                  ...
                  'ROBIN', 'BRINDLE', 'PAIGE', 'ROSETAIL', 'SAFI', 'CHIMERA', 'SMUDGED' 'COMBO', 'BLENDED', 'SCATTER', 'LIGHT', 
                  'BROKENONE', 'BROKENTWO', 'BROKENTHREE', 'BROKENFOUR', 'GLITCH', 'WAVE', 'STRIPESMASK', 'KOI', 'SKULL', 'LITTLE', 'O', 
                  'TOADSTOOL', 'SPOTSCHAOS', 'FOG', 'SUNSET', 'TAIL', 'MOOSTONE', 'PONITMASK', 'REVPONITMASK', 'ERAPONITMASK', 
                  'FALSESOLID', 'LYNXMASK']
