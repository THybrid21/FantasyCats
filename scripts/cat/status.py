    ...
    def get_rank_from_age(age, disable_random=False) -> CatRank:
        ...
        if age == CatAge.NEWBORN:
            ...
            return (
                CatRank.WARRIOR
                if disable_random
                else choice([CatRank.WARRIOR, CatRank.MEDICINE_CAT, CatRank.MEDIATOR, CatRank.PERMAQUEEN])
            )
        else:
