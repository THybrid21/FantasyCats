    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            new_cat.pelt = Pelt(
                ...
                para_young_sprite=cat["sprite_para_young"] if "sprite_para_young" in cat else None,
                ...
                albino=cat["albino"] if "albino" in cat else None,
                melanistic=cat["melanistic"] if "melanistic" in cat else None,
                ...
                magic=cat["magic"] if "magic" in cat else None,
