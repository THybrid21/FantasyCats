...
class ChooseMentorScreen(Screens):
    ...
    def find_next_previous_cats(self):
        ...
        for check_cat in Cat.all_cats_list:
            ...
            if (
                ...
                in ["apprentice", "medicine cat apprentice", "mediator apprentice", "permaqueen apprentice"]
    ...
    def get_valid_mentors(self):
        ...
        potential_permaqueen_mentors = [cat for cat in Cat.all_cats_list if not (cat.dead or cat.outside) and cat.status == 'permaqueen']
        valid_permaqueen_mentors = []
        invalid_permaqueen_mentors = []
        ...
        if self.the_cat.status == "apprentice":
            ...
            for cat in potential_permaqueen_mentors:
                # Assume cat is valid initially
                is_valid = True
                ...
                # Add to valid or invalid list based on checks
                if is_valid:
                    valid_permaqueen_mentors.append(cat)

            return potential_permaqueen_mentors
        return []
