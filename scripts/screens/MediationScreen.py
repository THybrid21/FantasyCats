    ...
    def draw_info_block(self, cat, starting_pos: tuple):
        ...
        if other_cat and len(cat.mate) > 0 and other_cat.ID in cat.mate:
            ...
            if get_clan_setting("second cousin mates"):
                ...
                check_cousins = other_cat.is_second_cousin(cat)
        ...
        if related and other_cat and not mates:
            ...
            if cat.is_uncle_aunt(other_cat):
                ...
                elif other_cat.genderalign in ("male", "trans male", "demiboy"):
            ...
            elif not get_clan_setting("second cousin mates") and other_cat.is_second_cousin(
                cat
            ):
                if other_cat.genderalign in ("female", "trans female", "demigirl"):
