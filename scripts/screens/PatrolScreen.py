    ...
    def update_button(self):
        ...
        if self.patrol_stage == "choose_cats":
            ...
            if any(
                ...
                (cat.status.rank.is_any_permaqueen_rank() for cat in self.current_patrol)
            ):
                self.patrol_type = "training"
            else:
                if self.patrol_type == "med":
            ...
            if self.patrol_type == "general":
                ...
                if any((cat.status.rank.is_any_permaqueen_rank() for cat in self.current_patrol)):
    ...
    def update_selected_cat(self):
        ...
        if self.selected_cat is not None:
            ...
            if (
                ...
                in [CatRank.MEDICINE_APPRENTICE, CatRank.APPRENTICE, CatRank.PERMAQUEEN_APPRENTICE]
