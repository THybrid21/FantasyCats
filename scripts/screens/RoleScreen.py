...
class RoleScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            ...
            if event.ui_element == self.back_button:
                ...
                self.update_selected_cat()
            elif event.ui_element == self.switch_permaqueen:
                self.the_cat.status_change("permaqueen", resort=True)
                self.update_selected_cat()
                ...
                self.update_selected_cat()
            elif event.ui_element == self.switch_permaqueen_app:
                self.the_cat.status_change("permaqueen apprentice", resort=True)
                self.update_selected_cat()
    ...
    def screen_switches(self):
        ...
        self.switch_permaqueen = UIImageButton(
            ui_scale(pygame.Rect((402, 0), (172, 36))),
            "screens.role.switch_permaqueen",
            get_button_dict(ButtonStyles.LADDER_MIDDLE, (172, 36)),
            object_id="@buttonstyles_ladder_middle",
        ...
        self.switch_permaqueen_app = UISurfaceImageButton(
            ui_scale(pygame.Rect((579, 0), (172, 52))),
            "screens.role.switch_permaqueen_app",
            get_button_dict(ButtonStyles.LADDER_MIDDLE, (172, 52)),
            object_id="@buttonstyles_ladder_middle",
    ...
    def update_selected_cat(self):
        ...
        paths = {
            ...
            CatRank.PERMAQUEEN: "queen_icon.png",
            CatRank.PERMAQUEEN_APPRENTICE: "queen_app_icon.png",
    ...
    def update_disabled_buttons(self):
        ...
        if self.the_cat.status.rank == CatRank.APPRENTICE:
            ...
            self.switch_permaqueen.disable()
            ...
            self.switch_permaqueen_app.enable()
            ...
            self.switch_warrior_app.disable()
            self.switch_permaqueen_app.disable()
        ...
        elif self.the_cat.status.rank == CatRank.PERMAQUEEN:
            if leader_invalid:
                self.promote_leader.enable()
            else:
                self.promote_leader.disable()
        ...
        elif self.the_cat.status.rank == CatRank.PERMAQUEEN_APPRENTICE:
            self.promote_leader.disable()
            self.promote_deputy.disable()
    ...
    def get_role_blurb(self):
        if self.the_cat.status.rank == CatRank.WARRIOR:
            ...
            output = "screens.role.blurb_permaqueen"
        elif self.the_cat.status.rank == CatRank.ELDER:
            ...
            output = "screens.role.blurb_permaqueen_app"
    ...
    def exit_screen(self):
        ...
        self.switch_permaqueen.kill()
        del self.switch_permaqueen
        ...
        self.switch_permaqueen_app.kill()
        del self.switch_permaqueen_app
